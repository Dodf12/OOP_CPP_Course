...
cout << "&bptr: " << &bptr << endl;
cout << "&cptr: " << &cptr << endl;
cout << "\nsizeof(aptr)=" << sizeof(aptr) << "; sizeof(bptr)=" << sizeof(bptr) <<
endl;
waitForUser();
...
{
cout << "double *last = p+2;\n";  //OUTPUTS 2 DOUBLES WORTH OF BYTES
...
for (int i=0; i<3; i++) //This is derefernecing each pointer after the previous one
